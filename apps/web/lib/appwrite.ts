...
export const APPWRITE_MASTERY_COLLECTION_ID =
  process.env.NEXT_PUBLIC_APPWRITE_MASTERY_COLLECTION_ID!;
export const APPWRITE_WORKOUTS_COLLECTION_ID =
  process.env.NEXT_PUBLIC_APPWRITE_WORKOUTS_COLLECTION_ID!;
export const APPWRITE_PRACTICE_COLLECTION_ID =
  process.env.NEXT_PUBLIC_APPWRITE_PRACTICE_COLLECTION_ID!;
export const APPWRITE_GROUPS_COLLECTION_ID =
  process.env.NEXT_PUBLIC_APPWRITE_GROUPS_COLLECTION_ID!;
export const APPWRITE_DAILY_WORKOUT_COLLECTION_ID =
